...
This work intends to assist in the formalisation of mathematics, by using Agda
as a theorem-prover.
The particular area we are concerned with is polynomials: proofs of identities
can be tedious (Fig.~\ref{ring-proof}), so we use Agda's programming capabilities to
