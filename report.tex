...
\begin{figure*}
  ...
  \begin{subfigure}[b]{0.4\textwidth}
    \raggedleft
    \ExecuteMetaData[Monoids.tex]{rhs-norm}
  ...
  \end{subfigure}
    ...
    \resizebox{0.3\textwidth}{!}{
      ...
      \end{subfigure}
    } \hfill \resizebox{0.3\textwidth}{!}{
      \begin{subfigure}[h]{0.4\textwidth}
        \ExecuteMetaData[Monoids.tex]{rhs-ast}
      \end{subfigure}
    }

  \begin{subfigure}[b]{0.4\textwidth}
    \raggedleft
    \ExecuteMetaData[Monoids.tex]{lhs-expr}
  \end{subfigure} \begin{subfigure}[b]{0.4\textwidth}
    \raggedright
    \ExecuteMetaData[Monoids.tex]{rhs-expr}
  \end{subfigure}
\end{figure*}
