...
The first crack was discovered in 1901: Russell's paradox.
Similar paradoxes soon followed, each representing a core error in some
fundamental theory.
Nonetheless, the work of papering over these cracks began in earnest:
Russell himself (along with Whitehead) published the Principia Mathematica, a
formalisation of contemporary mathematics based on a theory that accounted for
Russell's paradox.


\section{A Ring Solver in Agda}
