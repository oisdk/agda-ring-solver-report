...
Figuring out a \emph{good} solution is another task, however currently our
solver (after the application of some heuristics) outputs the following for the
lemma in figure~\ref{the-solver}:
\begin{verbatim}
x + y * 1 + 3
    ={ *-ident y }
x + y + 3
