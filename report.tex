...
\begin{figure*}
  \begin{tikzcd}
    & \includegraphics[draft=false,width=0.25\linewidth]{graphics/rhs-norm} & \includegraphics[draft=false,width=0.25\linewidth]{graphics/rhs-norm} & \\
    \includegraphics[draft=false,width=0.25\linewidth]{graphics/lhs-ast} & & & \includegraphics[draft=false,width=0.25\linewidth]{graphics/rhs-ast} \\
    & \includegraphics[draft=false,width=0.25\linewidth]{graphics/lhs-expr} & \includegraphics[draft=false,width=0.25\linewidth]{graphics/rhs-expr} &
  \end{tikzcd}
\end{figure*}
