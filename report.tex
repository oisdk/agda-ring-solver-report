...
Unfortunately for us, this approach won't work: the dangerous functions can
actually \emph{change} the size of what they return, depending on the
normalization.

\paragraph{Well-Founded Recursion}
\todo{This Works! Just fill in the prose.}
