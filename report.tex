...
\begin{enumerate}
  ...
  \item Next, we remove any ``step, reverse-step'' chains. Since we're
    converting expressions to normal form, the path may be Y-shaped, i.e., both
    sides of the equation will be rewritten into a common form, and then that 

    both paths may end in a long chain of
