...
\begin{document} 
    \begin{tikzpicture}
      ...
      \node (ln) at (-2, 2) {\includegraphics[draft=false,trim={25 10 35 10}]{rhs-norm}};
      \node (rn) at ( 2, 2) {\includegraphics[draft=false,trim={25 10 35 10}]{rhs-norm}};
      \node (la) at (-6, 0) {\includegraphics[draft=false,trim={25 10 22 10}]{lhs-ast}};
      \node (ra) at ( 6, 0) {\includegraphics[draft=false,trim={25 10 25 10}]{rhs-ast}};
      \node (le) at (-2,-2) {\includegraphics[draft=false,trim={25 10 23 10}]{lhs-expr}};
      \node (re) at ( 2,-2) {\includegraphics[draft=false,trim={25 10 25 10}]{rhs-expr}};
      ...
      \matrix[draw, below left] at ([yshift=25pt] current bounding box.south east) {
        \node[label=right:Constructed proof] {\(\AgdaField{≈}\)}; \\
        \node[label=right:Function evaluation] {\(\mapsto\)}; \\
        \node[label=right:Reflection] {\(\dashrightarroww\)}; \\
      };
    \end{tikzpicture}%
\end{document}
